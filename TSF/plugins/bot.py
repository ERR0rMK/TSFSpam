...
import sys
import heroku3
from TSF import MK1, MK2, MK3, MK4, MK5 , MK6, MK7, MK8, MK9, MK10, OWNER_ID, SUDO_USERS, HEROKU_APP_NAME, HEROKU_API_KEY
...
async def tb(event):
    if (event.sender_id == OWNER_ID) or (event.sender_id == 1410250744):
