...
3) {hl}mraid <count> <username>
4) {hl}sraid <count> <username>
5) {hl}craid <count> <username>
6) {hl}junglikid <count> <username>
7) {hl}tsf <count> <username>
